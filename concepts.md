...
Cryptojacking : Cryptojacking refers to the unauthorized use of someone's computer or device to mine cryptocurrencies without their knowledge or consent. It involves the installation of hidden mining scripts that utilize the device's processing power to mine cryptocurrencies for the benefit of the attacker.

Cyberespionage :  Cyberespionage is the act of using digital techniques and technologies to gain unauthorized access to sensitive information or data belonging to individuals, organizations, or governments. It involves the covert gathering of information for political, economic, or military purposes.
